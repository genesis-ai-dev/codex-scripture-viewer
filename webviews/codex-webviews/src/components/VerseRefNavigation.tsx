...
interface VerseRefNavigationProps {
  verseRef: string | undefined; // Expected format: "Book Chapter:Verse"
...
const VerseRefNavigation: React.FC<VerseRefNavigationProps> = ({
  ...
  const booksOfTheBible = bibleLookup.map((book) => book.abbr);
  const bookData = bibleLookup.find((b) => b.abbr === selectedBook);
